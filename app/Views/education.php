    ...
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="<?= base_url('education'); ?>"class="active">Education</a></li>
                ...
                <?php foreach($education as $edu) : ?>
                  <div class="timeline-item" data-aos="fade-up" data-aos-delay="200">
                    <div class="timeline-left">
                      <h4 class="company"><?= esc($edu['institution']) ?></h4>
                      <span class="period"><?= esc($edu['year_start']) ?> - <?= esc($edu['year_end']) ?></span>
                    </div>
                    <div class="timeline-dot"></div>
                    <div class="timeline-right">
                      <h3 class="position"><?= esc($edu['institution']) ?></h3>
                      <p class="description"><?= esc($edu['description']) ?></p>
                    </div>
                  </div>
                <?php endforeach; ?>
              <?php else: ?>
